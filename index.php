...
<html lang="en">
	<head>
		...
		<!-- Asegúrate de tener esta línea para Font Awesome -->
	...
	<body>
		<div class="principal1">
			<header>
				...
				<ul class="nav-center"> <!-- Añade la clase nav-center -->
					<li><a onclick="mostrar();" href="#informacion" class="botonJj">INFORMACION</a></li>
					<li><a onclick="mostrar();" href="mostrar/productos.php" class="botonJj">PRODUCTOS</a></li>
					<li><a onclick="mostrar();" href="#contacto" class="botonJj">CONTACTO</a></li>
				</ul>
				<a onclick="mostrar();" href="sesion/login.html" class="user-icon-container">
					<i id="persona" class="fas fa-user user-icon"></i>
				</a>
			</header>
		...
		<main class="main-content">
			...
			<!-- Contenedor principal para las secciones de información -->
